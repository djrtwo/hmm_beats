...
\noindent Thank you for taking the time to help with the evaluation of The System.

\section*{User Information}

\begin{tabular}{ l r }
    \Qq{Name}: \Qline{8cm} & \Qq{Age}: \Qline{1.5cm}
\end{tabular}
\\\\
\begin{tabular}{l c r}
    \Qq{Student}: Y / N & \Qq{Music Background}: Y / N & \Qq{CS Background}: Y / N
\end{tabular}

\section*{Instructed}

\minisec{Reaction to System-A}

\minisec{Reaction to System-B}
